                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td class="center">
                                    <a href="{!! url('admin/deletar_assedio/'.$dados->id) !!}" data-confirm ="Tem certeza ?"  class="" title="Deletar " data-toggle="tooltip" data-placement="top"><i class="glyphicon glyphicon-trash"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
