                        ...
                        <tr>
                           ...
                           <!-- <td align="center">{{$acordo->dataAtualizacao}}</td>  -->
                            <td class="center-margin" align="center">
                                ...
                                <a href="{!! url('admin/acordos/excluir/'.$acordo->id) !!}" data-confirm ="Tem certeza ?" title="deletar"><i class="fa fa-1x fa-trash"></i><span></span></a>
                                  <a href="{!! url('admin/acordos/'.$acordo->id) !!}"  title="{{$acordo->status}}" data-toggle="tooltip" data-placement="top">
