    ...
    <div class="">
        ...
        <div class="row"> <!--form action -->
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Cadastramento de <small>{{$titulo or 'Dados referente a Seguran�a Bancaria'}}</small></h2>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            <label for="n_titulo">Tipo Ocorr�ncia*:</label>
                                            <div class="controls">
                                                <select class="form-control"  id="c_tipo" name="ocorrencia" required>
                                                     <option value="">Selecione a Ocorr�ncia</option>
                                                     <option value="Arrombamento">Arrombamento</option>
                                                     <option value="Assalto">Assalto</option>
                                                     <option value="Explos�o">Explos�o</option>
