                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td align="center">{{$dados->dataCriacao or '0 mes'}}</td>
                                <td class="center">
                                    <a href="{!! url('admin/detalhar_reatituicao/'.$dados->id) !!}" class="" title="Detalhar" data-toggle="tooltip" data-placement="top"><i class="glyphicon glyphicon-zoom-in"></i></a>
                                    <a href="{!! url('admin/deletar_reatituicao/'.$dados->id) !!}" data-confirm ="Tem certeza ?" title="Deletar " data-toggle="tooltip" data-placement="top"><i class="glyphicon glyphicon-trash"></i></a>
