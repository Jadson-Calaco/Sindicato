        ...
        <div class="row"> <!--form action -->
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <form action="{{url('/admin/informativos/salvar') }}" method="POST" enctype="multipart/form-data" id="demo-form" data-parsley-validate class="form-horizontal form-label-left">
                        {{ csrf_field() }}
                        <!--div class="x_content">
                ...
                <div class="actionBar">
                    <div class="msgBox">
                        ...
                        <button type="submit" class="btn btn-success" formaction="{{url('/admin/informativos/atualizar/'.$informativo->id) }}">Atualizar</button>
                        @else
                        ...
                        <tr>
                           ...
                           <!-- <td align="center">{{$informativo->dataAtualizacao}}</td> -->
                            <td class="center-margin" align="center">
                                <a href="{!! url('admin/informativos/editar/'.$informativo->id) !!}" title="Editar"><i class="fa fa-1x fa-pencil-square-o"></i><span></span></a>
                                <a href="{!! url('admin/informativos/excluir/'.$informativo->id) !!}" data-confirm ="Tem certeza ?"  title="deletar"><i class="fa fa-1x fa-trash"></i><span></span></a>
                                 <a href="{!! url('admin/informativos/'.$informativo->id) !!}" class="" title="{{$informativo->status}}" data-toggle="tooltip" data-placement="top">
