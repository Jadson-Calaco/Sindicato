                                        ...
                                        <ul>
                                            <li class="clearfix m_bottom_15">
                                                <div class="f_left half_column">
                                                    <label for="cf_name" class="required d_inline_b m_bottom_5 required">Seu nome</label>
                                                    <input type="text" id="cf_name" name="cf_name" class="full_width r_corners" required="true">
                                                </div>
                                                <div class="f_left half_column">
                                                    <label for="cf_email" class="required d_inline_b m_bottom_5 required">Seu e-mail</label>
                                                    <input type="email" id="cf_email" name="cf_email" class="full_width r_corners" required="true">
                                                </div>
                                            </li>
                                            <li class="m_bottom_15">
                                                <label for="cf_subject" class="required d_inline_b m_bottom_5 required">Assunto </label>
