								...
								<div class="col-lg-12 col-md-12 col-sm-12 m_xs_bottom_10">
									...
									<form action="{{ url('/assedio')}}" method="post"
										...
										<ul>
											...
											<li class="clearfix m_bottom_15">
												<div class="f_left half_column">
													<label for="cf_sexo" class="required d_inline_b m_bottom_5">Sexo</label>
													<div class="custom_select relative">
														<div class="select_title type_2 r_corners relative color_dark mw_0">Selecione</div>
											...
											<li class="m_bottom_15">
											    <label for="sexo_Denunciado" class="required d_inline_b m_bottom_5">Sexo </label>
												<div class="custom_select relative">
													<div class="select_title type_2 r_corners relative color_dark mw_0">Selecione</div>
													<ul id="filter_portfolio" class="select_list d_none"></ul>
